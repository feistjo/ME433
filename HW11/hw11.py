...
while True:
    ...
    #ind = 0
    for d in range(0, 2 * cam.width * cam.height, 4):#list(range(2 * cam.width * 6, 2 * cam.width * 8,4))+list(range(2 * cam.width * 13, 2 * cam.width * 14,4))+list(range(2 * cam.width * 20, 2 * cam.width * 21,4)):
        ind = int(0.5*d)
        u = buf[d+1] - 128
        v = buf[d+3] - 128
    ...
    for c in range(red.size):#list(range(6*cam.width, 7*cam.width))+list(range(13*cam.width, 14*cam.width))+list(range(20*cam.width, 21*cam.width)):
